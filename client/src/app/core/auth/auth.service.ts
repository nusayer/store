...
export class AuthService {
  ...
  public loginAdminUser(adminUser: StoreUser): any {
    return this.http.post<any>(this.loginUrl, adminUser);
  }

  public loginUser(User: StoreUser): any {
    return this.http.post<any>(this.loginUrl, User);
  }

  public loginDeveloper(storeUser: User): any {
    return this.http.post<any>(this.loginUrl, storeUser);
  }
  ...
  public setHeaders(res: any, role: string, StoreId: number, username: string): void {
    ...
    localStorage.setItem(BrowserStorageFields.STORE_ID, String(StoreId));
  ...
  public getStoreId(): string {
    return JSON.parse(localStorage.getItem(BrowserStorageFields.STORE_ID) as string);
  }
  ...
  public clearSession(): void {
    ...
    localStorage.removeItem(BrowserStorageFields.STORE_ID);
